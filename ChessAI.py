...
# goal of our AI => the white piece is trying to make the positive score and the black piece is trying to make the negative score
...
def findMoveNegaMaxAlphaBeta(gs, validMoves, depth, alpha, beta, turnMultiplier):
    ...
    # move ordering - we will do this later
    maxScore = -CHECKMATE
    for move in validMoves:
        gs.makeMove(move)
        nextMoves = gs.getValidMoves()
